<header class="header-bhv ree-header fixed-top">
    <div class="mini-header-bar">
      	<div class="sideone">
        	<a href="tel:123456789" class="contactinfo"><i class="far fa-envelope"></i> dkp@sulselprov.go.id</a>
    ...
    <div class="container-fluid m-p-l-r-0">
      	<div class="menu-header horzontl">
	        ...
	        <div class="ree-nav" role="navigation">
	          	<ul class="nav-list">
	            	<li class="megamenu">
	            		<a href="{{ route('/') }}" class="menu-links">Beranda</a>
	            	</li>
	            	<li class="megamenu">
                    ...
                    <li class="megamenu mega-small">
                        <a href="{{ route('landing.pengaduan') }}"  class="menu-links">Pengaduan</a>
                    </li>
                     <li class="megamenu mega-small">
                        <a href="#"  class="menu-links">Layanan & Dokumen</a>
                    </li>
	            	<li class="megamenu mega-small">
	            		<a href="#"  class="menu-links">Kontak Kami</a>
	            	</li>
	        ...
	        <div class="ree-nav-cta">
	        	<ul>
	        		<li><a href="{{ route('login') }}" class="ree-btn ree-btn0 ree-btn-grdt2">Login</a></li>
	        	</ul>
	        </div>
        	...
        	<nav id="main-nav">
        		<ul>
        			...
        			<li>
                        <a href="{{ route('landing.tentang') }}">Tentang</a>
                    </li>
                    <li>
                        <a href="{{ route('landing.sop') }}">Sop</a>
                    </li>
                    <li>
