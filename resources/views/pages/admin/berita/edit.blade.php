            ...
            <div class="col-sm-12 col-lg-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <form method="POST" action="{{ route('admin.berita.update',['id' => $result->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control ckeditor @error('isi') is-invalid @enderror" id="ckeditor" name="isi" rows="5">{{ $result->isi }}</textarea>
                                @error('isi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('url_video') is-invalid @enderror" name="url_video" id="exampleInputText1" value="{{ old('url_video',$result->url_video) }}">
                                @error('url_video')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
