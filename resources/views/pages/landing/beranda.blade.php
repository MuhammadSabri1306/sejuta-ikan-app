                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 vcenter">
                            <div class="sol-image m-mt30">
                                <img src="{{ asset('pimpinann-.png') }}" alt="PLT Gubernur" class="img-fluid" data-aos="fade-in" data-aos-delay="400">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 vcenter">
                            <div class="hero-content-x">
                                <p class="mb10 ree-tt">Selamat Datang di e-Sejutaikan</p>
                                <h1 class="mb30" data-aos="fade-in" data-aos-delay="200"><span class="ree-tt">Sertifikat Hasil Pengujian Produk Perikanan</span></h1>
                                <h4>UPT Balai Penerapan Mutu Produk Perikanan DKP Prov. SulSel</h4>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 vcenter">
            ...
            <div class="row mt30">
                ...
                <div class="col-md-3">
                    <a href="{{ route('register') }}">
                        <img src="{{ asset('registrasi.png') }}" class="rounded float-left" alt="gambar-layanan" style="width: 100%;">
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('landing.pantau-permohonan') }}">
                        <img src="{{ asset('pantau-status-permohonan.png') }}" class="rounded float-left" alt="gambar-layanan" style="width: 100%;">
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('landing.alur-permohonan') }}">
                        <img src="{{ asset('alur-permohonan.png') }}" class="rounded float-left" alt="gambar-layanan" style="width: 100%;">
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="https://api.whatsapp.com/send?phone=+6281244962783&text=Assalamualaikum">
                        <img src="{{ asset('customer-service.png') }}" class="rounded float-left" alt="gambar-layanan" style="width: 100%;">
                    </a>
                </div>
                {{-- end --}}
        ...
        <div class="container">
            ...
            <div class="row mt30">
                ...
                <div class="col-md-8 col-sm-8 vcenter">
                    <img src="{{ asset('kris.jpeg') }}" alt="Payment" class="img-fluid" data-aos="fade-in" data-aos-delay="400" style="margin-bottom:12px">
                </div>
                <div class="col-md-2 col-sm-2">
                </div>
                <div class="col-md-12 col-sm-12">
                    ...
                    <h6>1. Rekening Bank Sulselbar Nomor: 13000167319 atas nama Kas Umum Daerah Provinsi Sulawesi Selatan</h6>
                ...
                <div class="col-lg-12">
                    <div class="full-work-block  owl-carousel">
                        ...
                        <div class="fwb-main-x fwb-a">
                            <div class="work-thumbnails">
                                <a href="#">
                                    <img src="{{ asset('app-assets/landing/assets/images/slide1.jpg') }}" alt="portfolio reevan" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        <div class="fwb-main-x fwb-a">
                            <div class="work-thumbnails">
                                <a href="#">
                                    <img src="{{ asset('app-assets/landing/assets/images/slide2.jpg') }}" alt="portfolio reevan" class="img-fluid">
                                </a>
                            </div>
                        </div>
                        <div class="fwb-main-x fwb-a">
                            <div class="work-thumbnails">
                                <a href="#">
                                    <img src="{{ asset('app-assets/landing/assets/images/slide3.jpg') }}" alt="portfolio reevan" class="img-fluid">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="r-bg-a sec-pad">
        <div class="container">
            ...
            <div class="row mt60">
                ...
                <div class="col-md-6 col-12">
                    <img src="{{ asset('baru.jpeg') }}" alt="sop" style="filter: drop-shadow(10px 10px 4px #777777); width: 100%;">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="sol-img m-mt30">
                        <img src="{{ asset('app-assets/landing-new/images/others/team-business.jpg') }}" alt="survei" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="pera-block ml50">
                        <h2><span class="ree-tt">Survei Kepuasan Masyarakat</span></h2>
                        <p>Pemerintah berupaya meningkatkan kualitas pelayanan masyarakat demi tercapainya harapan dan tuntutan publik sesuai Keputusan Menteri Pendayagunaan Aparatur Negara Nomor 14 Tahun 2017 tentang Pedoman Umum Penyusunan Survei Kepuasan Masyarakat Unit Penyelenggara Pelayanan Publik. Mengacu pada hal tersebut, maka Tim Survei dan Pengolah Data Survei Kepuasan Masyarakat (SKM) UPT BPMPP telah melakukan pengukuran Survei Kepuasaan Masyarakat terhadap pelayanan Pengujian Hasil Perikanan</p>
