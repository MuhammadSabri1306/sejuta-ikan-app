...
class PermohonanController extends Controller {
    ...
    public function cetak_sertifikat($id) {
        ...
        // $pdf = PDF::loadView('pages.pemohon.permohonan.cetak-sertifikat', compact('permohonan', 'parameters_select'))->setPaper(0, 0, 360, 360, 'potrait');
        // $pdf = PDF::loadView('pages.pemohon.permohonan.cetak-sertifikat', compact('permohonan', 'parameters_select'))->setPaper('L', 'potrait');
